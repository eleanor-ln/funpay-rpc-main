...
(self.webpackChunkStylus = self.webpackChunkStylus || []).push([ [ "popup_search_js" ], {
  5517(_, ee, oe) {
    ...
    function renderYears() {
      ...
      selects.forEach((sel, selNum) => {
        if (texts.length !== sel.length || texts.some((v, i) => v !== sel[i].text)) {
          ...
          sel.value = value || ((_ = sel[(selNum ? "first" : "last") + "Child"]) == null ? void 0 : _.value);
        }
      });
    ...
    function render() {
      ...
      for (;plantAt < PAGE_LENGTH && slot && slot.id === RESULT_ID_PREFIX + ((_ = results[startAt]) == null ? void 0 : _.i); ) {
        var _;
    ...
    function calcCategory({retry} = {}) {
      ...
      if (u != null && u.href) if (u.protocol === "file:") category = "file:"; else if (u.protocol === location.protocol) category = STYLUS_CATEGORY; else {
